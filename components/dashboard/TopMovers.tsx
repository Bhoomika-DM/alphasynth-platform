...
export default function TopMovers({}: TopMoversProps) {
  ...
  return (
    <div
      ref={cardRef}
      className="relative group bg-white border border-[#A7C4A0]/30 rounded-2xl p-8 shadow-[0_4px_12px_rgba(0,0,0,0.05)] transition-all duration-200"
    >
      
      <div className="relative space-y-6">
        <div className="flex items-center justify-between">
          <div>
            <h3 className="text-xl font-jakarta font-bold text-[#1F2933] mb-1">Top Movers</h3>
