      ...
      <div className="relative z-10 flex items-center gap-4">
        ...
        >
          <div className="w-12 h-12 flex items-center justify-center bg-gradient-to-br from-blue-600 to-blue-700 rounded-xl shadow-lg shadow-blue-500/30">
            <span className="text-lg font-jakarta font-black text-white">{rank}</span>
          </div>
          {/* Rank glow */}
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-start justify-between mb-2">
            <div className="flex-1 min-w-0">
              <h4 className="text-lg font-jakarta font-black text-white leading-tight mb-1">
                {name}
              </h4>
              <div className="flex items-center gap-3 text-sm font-jakarta text-white/60">
            ...
            <motion.div
              ...
              className={`px-3 py-1 border rounded-lg text-xs font-jakarta font-bold uppercase tracking-wider ${confidenceBadge[confidence]}`}
            >
              {confidence}
            </motion.div>
          </div>
        ...
        <div className="flex items-center gap-8">
          ...
          <div className="text-center">
            <div className="text-xs font-jakarta text-white/50 uppercase tracking-widest mb-2 font-bold">Score</div>
            <motion.div 
              initial={{ scale: 0 }}
              animate={{ scale: 1 }}
              transition={{ delay: index * 0.08 + 0.3, type: "spring" }}
              className={`text-3xl font-jakarta font-black ${isBullish ? 'text-green-400' : 'text-red-400'} drop-shadow-lg`}
            >
              {score.toFixed(1)}
            </motion.div>
            <div className={`text-xs font-jakarta font-semibold mt-1 ${isBullish ? 'text-green-400/70' : 'text-red-400/70'}`}>
          ...
          <div className="w-44">
            <div className="flex items-center justify-between mb-2">
              <div className="text-xs font-jakarta text-white/50 uppercase tracking-widest font-bold">Deviation</div>
            ...
            <div className="relative h-4 bg-white/5 rounded-full overflow-hidden border border-white/10">
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="text-xs font-jakarta font-bold text-white/80">
                  {deviationPercent.toFixed(0)}%
                </div>
              </div>
            </div>
            <div className="flex justify-between mt-1 text-xs font-jakarta text-white/40">
              <span>0.0</span>
              <span>5.0</span>
            </div>
          </div>
