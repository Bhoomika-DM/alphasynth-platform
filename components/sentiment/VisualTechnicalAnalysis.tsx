      ...
      <div className="relative z-10">
        ...
        <div className="flex items-center justify-between mb-6">
          <div className="flex-1">
            <h3 className="text-2xl font-jakarta font-black text-white mb-1">
          ...
          <motion.button
            ...
            disabled={isRunning}
            className={`ml-4 px-6 py-2.5 bg-gradient-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 rounded-xl text-sm font-jakarta font-bold text-white shadow-lg transition-all duration-300 ${
          ...
          >
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                ...
                <div className="p-4 bg-gradient-to-br from-red-500/20 to-red-500/5 border border-red-500/30 rounded-xl">
                  <div className="text-xs font-jakarta text-white/60 mb-3">Composite TA Score</div>
                  <div className="flex items-center justify-between">
                    <div>
                      <div className="text-sm font-jakarta text-white/80 mb-1">
                        Analyzed chart of AAPL
                      </div>
                      <div className="text-xs font-jakarta text-white/60">
                    ...
                    <div className="relative w-24 h-24">
                      ...
                      <div className="absolute inset-0 flex items-center justify-center">
                        <div className="text-3xl font-jakarta font-black text-red-400">38</div>
                      </div>
                    </div>
                  </div>
                  <div className="mt-3 px-3 py-1 bg-red-500/20 rounded-lg text-center">
                    <span className="text-sm font-jakarta font-bold text-red-400">SELL</span>
                  </div>
                </div>

                {/* Radar Chart */}
                <div className="p-4 bg-white/5 border border-white/10 rounded-xl">
                  <div className="text-xs font-jakarta text-white/60 mb-2">
                ...
                <div className="p-4 bg-gradient-to-br from-red-500/10 to-transparent border border-red-500/30 rounded-xl">
                  <div className="flex items-center justify-between mb-4">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-sm font-jakarta font-bold text-white">Indicators & Oscillators</span>
                    </div>
                    <div className="text-3xl font-jakarta font-black text-red-400">47</div>
                  </div>
                  <div className="text-xs font-jakarta text-white/60 mb-3">30% of composite</div>
                  ...
                  <div className="space-y-2">
                    {[
                      ...
                      <div key={i} className="flex items-center justify-between p-2 bg-black/20 rounded-lg hover:bg-black/30 transition-all">
                        <div className="flex-1">
                          <div className="text-xs font-jakarta text-white">{indicator.name}</div>
                          <div className="text-[10px] font-jakarta text-white/50">{indicator.desc}</div>
                        </div>
                        <div className="text-xs font-jakarta text-white/80 mr-2">{indicator.value}</div>
                        <div className={`px-2 py-0.5 rounded text-[10px] font-jakarta font-bold ${
                ...
                <div className="p-4 bg-gradient-to-br from-red-500/10 to-transparent border border-red-500/30 rounded-xl">
                  <div className="flex items-center justify-between mb-4">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-sm font-jakarta font-bold text-white">Elliott Wave & Fibonacci</span>
                    </div>
                    <div className="text-3xl font-jakarta font-black text-red-400">35</div>
                  </div>
                  <div className="text-xs font-jakarta text-white/60 mb-3">30% of composite</div>

                  <div className="space-y-3">
                    <div className="p-2 bg-black/20 rounded-lg">
                      <div className="text-xs font-jakarta text-white mb-1">Trend</div>
                      <div className="flex items-center justify-between">
                        <span className="text-xs font-jakarta text-white/80">downtrend</span>
                        <span className="px-2 py-0.5 bg-red-500/20 text-red-400 rounded text-[10px] font-bold">SELL</span>
                      </div>
                      <div className="text-[10px] font-jakarta text-white/50 mt-1">
                        Wave 2 — Corrective wave, entry points in an uptrend pair
                      </div>
                    </div>

                    <div className="p-2 bg-black/20 rounded-lg">
                      <div className="text-xs font-jakarta text-white mb-1">Wave position</div>
                      <div className="flex items-center justify-between">
                        <span className="text-xs font-jakarta text-white/80">unknown</span>
                    ...
                    <div className="p-2 bg-black/20 rounded-lg">
                      <div className="text-xs font-jakarta text-white mb-1">Strategy</div>
                      <div className="text-xs font-jakarta text-white/80">none</div>
                      <div className="text-[10px] font-jakarta text-white/50 mt-1">
                    ...
                    <div className="mt-3">
                      <div className="flex items-center justify-between mb-2">
                        <span className="text-xs font-jakarta text-white">Nearest support</span>
                        <div className="flex items-center gap-2">
                          <span className="text-xs font-jakarta text-white">$0.0</span>
                          <span className="px-2 py-0.5 bg-blue-500/20 text-blue-400 rounded text-[10px] font-bold">BUY</span>
                        </div>
                      </div>
                      <div className="flex items-center justify-between">
                        <span className="text-xs font-jakarta text-white">Nearest resist.</span>
                        <div className="flex items-center gap-2">
                          <span className="text-xs font-jakarta text-white">$0.0</span>
                          <span className="px-2 py-0.5 bg-red-500/20 text-red-400 rounded text-[10px] font-bold">SELL</span>
                        </div>
                    ...
                    <div className="mt-3 pt-3 border-t border-white/10">
                      <div className="text-xs font-jakarta text-white mb-2">Fib zone: unknown</div>
                      <div className="text-xs font-jakarta text-white mb-2">Fibonacci levels</div>
                      <div className="space-y-1">
                        {fibLevels.map((fib, i) => (
                          <div key={i} className="flex items-center justify-between text-[10px] font-jakarta">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                <div className="p-4 bg-gradient-to-br from-red-500/10 to-transparent border border-red-500/30 rounded-xl">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                      <IconChartBar className="w-4 h-4 text-white" stroke={1.5} />
                      <span className="text-sm font-jakarta font-bold text-white">Chart Patterns</span>
                    </div>
                    <div className="text-3xl font-jakarta font-black text-red-400">25</div>
                  </div>
                  <div className="text-xs font-jakarta text-white/60 mt-1">20% of composite</div>
                </div>
                ...
                <div className="p-4 bg-gradient-to-br from-yellow-500/10 to-transparent border border-yellow-500/30 rounded-xl">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-sm font-jakarta font-bold text-white">Candlestick Patterns</span>
                    </div>
                    <div className="text-3xl font-jakarta font-black text-yellow-400">50</div>
                  </div>
                  <div className="text-xs font-jakarta text-white/60 mt-1">20% of composite</div>
                </div>
              </div>
              ...
              <div className="p-3 bg-yellow-500/10 border border-yellow-500/30 rounded-xl">
                <div className="flex items-center gap-2">
                  ...
                  <div className="text-xs font-jakarta text-yellow-400 font-bold">
