...
const categoryColors = {
  ...
  SENTIMENT: { bg: 'bg-[#A7C4A0]/10', border: 'border-[#A7C4A0]/30', text: 'text-[#A7C4A0]', bar: 'bg-[#A7C4A0]' },
}
            ...
            <div className="relative z-10 flex items-center gap-3">
              ...
              <div className="flex-shrink-0">
                <div className={`w-10 h-10 flex items-center justify-center ${colors.bg} ${colors.border} border rounded-lg`}>
                  <span className={`text-sm font-jakarta font-black ${colors.text}`}>#{factor.id}</span>
                </div>
              </div>
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center gap-2 mb-1">
                  <h4 className="text-sm font-jakarta font-bold text-white truncate">
                    {factor.name}
                  </h4>
                  <motion.div
                    initial={{ scale: 0 }}
                    ...
                    className={`px-2 py-0.5 border rounded-md text-[10px] font-jakarta font-bold ${confidenceBadge[factor.confidence]}`}
                  >
                    {factor.confidence}
                  </motion.div>
                </div>
                <div className="flex items-center gap-3 text-[10px] font-jakarta text-white/50">
              ...
              <div className="flex items-center gap-4">
                ...
                <div className="text-right w-12">
                  <motion.div 
                    ...
                    className={`text-xl font-jakarta font-black ${
                      factor.confidence === 'NO DATA' 
                        ? 'text-gray-400' 
                        : isBullish 
                          ? 'text-green-400' 
