    ...
    >
          ...
          >
            <div className="text-center">
              <motion.div 
                ...
                className={`text-5xl font-jakarta font-black ${colors.text} drop-shadow-2xl ${colors.glow} shadow-2xl`}
              >
                {score.toFixed(1)}
              </motion.div>
              <div className="text-[10px] font-jakarta text-white/40 mt-0.5">out of 5.0</div>
            </div>
          </motion.div>
        </div>
      </div>
      ...
      >
        <div className="flex items-center justify-center gap-2">
          ...
          />
          <span className={`text-lg font-jakarta font-bold ${colors.text} uppercase tracking-wide`}>
            {status}
          </span>
        </div>
        ...
        <div className="pt-3 border-t border-white/10 space-y-1.5">
          <div className="flex items-center justify-between text-[10px] font-jakarta text-white/50">
          ...
          <div className="text-[10px] font-jakarta text-white/40">
        ...
        <div className="pt-3 border-t border-white/10">
          <div className="text-[10px] font-jakarta text-white/40 uppercase tracking-wider mb-0.5">
            FA Score Adjustment
          </div>
          <div className={`text-2xl font-jakarta font-black ${colors.text}`}>
            0.00
          </div>
        </div>
      </motion.div>
