      ...
      <div className="relative z-10">
        ...
        <div className="flex items-start justify-between mb-6">
          ...
          <motion.button
            ...
            disabled={isRunning}
            className={`px-6 py-2 bg-gradient-to-r from-blue-600 to-blue-700 rounded-xl text-sm font-jakarta font-bold text-white shadow-lg ${
            ...
            >
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-xl font-jakarta font-black text-white">Chart Patterns</span>
                    </div>
                    <div className="text-4xl font-jakarta font-black text-red-400">25</div>
                  </div>

                  <div className="p-4 bg-white/5 border border-white/10 rounded-xl">
                    <div className="text-xs font-jakarta text-white/80 mb-3">
                    ...
                    <div className="p-3 bg-red-500/10 border border-red-500/30 rounded-lg mb-3">
                      <div className="flex items-center justify-between mb-2">
                        <span className="text-sm font-jakarta font-bold text-white">Double Top</span>
                    ...
                    <div className="space-y-2">
                      {chartPatterns.slice(1).map((pattern, i) => (
                        <div key={i} className="flex items-center justify-between p-2 bg-black/20 rounded-lg">
                          <span className="text-xs font-jakarta text-white/80">{pattern.name}</span>
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-xl font-jakarta font-black text-white">Candlestick Patterns</span>
                    </div>
                    <div className="text-4xl font-jakarta font-black text-yellow-400">50</div>
                  </div>
                    ...
                    <div className="grid grid-cols-2 gap-2">
                      {candlestickPatterns.map((pattern, i) => (
                        <div key={i} className="p-2 bg-black/20 rounded-lg">
                          <div className="text-xs font-jakarta font-bold text-white mb-1">
                            {pattern.name}
                          </div>
                          <div className="text-[10px] font-jakarta text-white/60">
                            {pattern.description}
                          </div>
                        </div>
                      ))}
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                <div className="p-3 bg-white/5 border border-white/10 rounded-xl">
                  <div className="text-xs font-jakarta text-white/60 mb-1">Key levels</div>
                ...
                <div className="p-3 bg-white/5 border border-white/10 rounded-xl">
                  <div className="text-xs font-jakarta text-white/60 mb-1">ma200</div>
                  <div className="text-sm font-jakarta font-bold text-white">
                    <span className="text-red-400">$247.7</span> · <span className="text-blue-400">$236.3</span>
                  </div>
                </div>
                <div className="p-3 bg-white/5 border border-white/10 rounded-xl">
                  <div className="text-xs font-jakarta text-white/60 mb-1">bb_lower</div>
                  <div className="text-sm font-jakarta font-bold text-green-400">$234.5</div>
                </div>
                <div className="p-3 bg-white/5 border border-white/10 rounded-xl">
                  <div className="text-xs font-jakarta text-white/60 mb-1">fib_382</div>
                  <div className="text-sm font-jakarta font-bold text-green-400">$215.3</div>
                </div>
              </div>
            </motion.div>
          )}
        ...
        {isRunning && (
          <div className="text-center py-12">
            ...
            <p className="text-white/60 font-jakarta">Scanning for patterns...</p>
          </div>
        )}
      </div>
    </motion.div>
