  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
      <div className="relative w-full max-w-md bg-white rounded-2xl shadow-2xl overflow-hidden">
        ...
        <button
          onClick={onClose}
          className="absolute top-4 right-4 z-10 w-8 h-8 flex items-center justify-center rounded-full bg-[#F4F7F2] hover:bg-[#E5E7EB] transition-colors"
        >
          <IconX className="w-5 h-5 text-[#6B7280]" stroke={2} />
        </button>
        ...
        <div className="p-8">
          ...
          <div className="flex items-center justify-center mb-6">
            <div className="flex items-center gap-3">
              ...
              <span className="text-[28px] font-semibold font-jakarta">
          ...
          <div className="text-center mb-6">
            <h2 className="text-2xl font-jakarta font-black text-[#1F2933] mb-2">
          ...
          {error && (
            <div className="mb-4 p-3 bg-[#C85A54]/10 border border-[#C85A54]/20 rounded-lg">
              <p className="text-sm text-[#C85A54] font-jakarta">{error}</p>
            </div>
          )}
          ...
          <form onSubmit={mode === 'signup' ? handleSignUp : handleSignIn} className="space-y-4">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-3 bg-[#6A994E] hover:bg-[#5A8A4E] text-white rounded-lg font-jakarta font-semibold transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
            >
          ...
          <div className="flex items-center gap-3 my-6">
            ...
            <span className="text-xs text-[#6B7280] font-jakarta">OR</span>
            <div className="flex-1 h-px bg-[#E5E7EB]"></div>
          </div>
          ...
          <div className="mt-6 text-center">
            <p className="text-sm text-[#6B7280] font-jakarta">
              ...
              <button
                ...
                className="text-[#6A994E] font-semibold hover:underline"
              >
