...
const sections = [
  ...
  { 
    ...
    color: 'from-[#0D7C8C]/20 to-[#2E4D8E]/20',
    borderColor: 'border-[#0D7C8C]/40',
    iconColor: '#0D7C8C', // Teal
    iconColorActive: '#FFFFFF'
  }
]
            ...
            <button
              ...
              className={`group relative px-6 py-3 rounded-xl border transition-colors duration-100 flex items-center gap-3 ${
                isActive
                  ...
                  : 'bg-white border-[#E2E8F0] hover:border-[#2E4D8E]/30 hover:bg-[#F8F9FB]'
              }`}
            >
              <Icon 
                className="w-5 h-5 transition-colors duration-100" 
                stroke={1.5}
                style={{ color: isActive ? section.iconColorActive : section.iconColor }}
              />
