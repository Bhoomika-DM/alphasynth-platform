...
export default function FactorCard({ category, score, factors, color, index }: FactorCardProps) {
  const colorClasses = {
    ...
    sage: {
      bg: 'from-[#0D7C8C]/20 via-[#0D7C8C]/10 to-transparent',
      border: 'border-[#0D7C8C]/30 hover:border-[#0D7C8C]/50',
      text: 'text-[#0D7C8C]',
      glow: 'group-hover:shadow-[#0D7C8C]/20'
    },
    cyan: {
      ...
      <div className="relative z-10">
        <div className="flex items-center justify-between mb-2">
          <motion.span 
            ...
            className={`text-[10px] font-bold ${classes.text} uppercase tracking-widest`}
          >
            {category}
          </motion.span>
          <motion.span 
            ...
            className={`text-3xl font-black ${classes.text} drop-shadow-lg`}
          >
            {score.toFixed(1)}
          </motion.span>
        </div>
