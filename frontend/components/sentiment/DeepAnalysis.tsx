  ...
  return (
    <div className="bg-gradient-to-br from-white/[0.07] to-white/[0.02] border border-white/[0.08] rounded-2xl p-6">
      <div className="flex items-center gap-3 mb-6">
        ...
        <h3 className="text-xl font-bold text-white">DEEP RESEARCH ANALYSIS</h3>
      </div>
      ...
      >
        {activeTab === 'golden' && (
          <div className="space-y-4">
            <div className="p-4 bg-green-500/10 border border-green-500/30 rounded-xl">
              <h4 className="text-sm font-bold text-green-400 mb-2">OPTIMAL SCENARIO</h4>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="p-4 bg-white/5 border border-white/10 rounded-xl">
                <div className="text-xs text-white/60 mb-1">Expected Return (90D)</div>
                <div className="text-2xl font-bold text-green-400">+12.5%</div>
              </div>
              <div className="p-4 bg-white/5 border border-white/10 rounded-xl">
                <div className="text-xs text-white/60 mb-1">Confidence Level</div>
        ...
        {activeTab === 'bull-bear' && (
          <div className="space-y-4">
            <div className="p-4 bg-green-500/10 border border-green-500/30 rounded-xl">
              <h4 className="text-sm font-bold text-green-400 mb-2">BULL CASE</h4>
            ...
            <div className="p-4 bg-red-500/10 border border-red-500/30 rounded-xl">
              <h4 className="text-sm font-bold text-red-400 mb-2">BEAR CASE</h4>
              <ul className="space-y-2 text-sm text-white/70">
        ...
        {activeTab === 'red-team' && (
          <div className="space-y-4">
            <div className="p-4 bg-orange-500/10 border border-orange-500/30 rounded-xl">
              <h4 className="text-sm font-bold text-orange-400 mb-2">CRITICAL RISKS</h4>
              <ul className="space-y-2 text-sm text-white/70">
        ...
        {activeTab === 'integrity' && (
          <div className="space-y-4">
            <div className="p-4 bg-blue-500/10 border border-blue-500/30 rounded-xl">
              <h4 className="text-sm font-bold text-blue-400 mb-2">DATA QUALITY</h4>
              <p className="text-sm text-white/70">
            ...
            <div className="grid grid-cols-3 gap-4">
              ...
              <div className="p-4 bg-white/5 border border-white/10 rounded-xl text-center">
                <div className="text-xs text-white/60 mb-1">Model Confidence</div>
                <div className="text-xl font-bold text-green-400">High</div>
              </div>
              <div className="p-4 bg-white/5 border border-white/10 rounded-xl text-center">
                <div className="text-xs text-white/60 mb-1">Audit Status</div>
                <div className="text-xl font-bold text-green-400">Clean</div>
              </div>
            </div>
          </div>
        )}
        ...
        {activeTab === 'simulation' && (
          <div className="space-y-4">
            <div className="p-4 bg-[#0D7C8C]/10 border border-[#0D7C8C]/30 rounded-xl">
              <h4 className="text-sm font-bold text-[#0D7C8C] mb-2">SCENARIO ANALYSIS</h4>
              <p className="text-sm text-white/70 mb-4">
                Monte Carlo simulation with 10,000 iterations across various market conditions.
              </p>
              <div className="grid grid-cols-3 gap-4">
                <div className="p-3 bg-white/5 border border-white/10 rounded-lg">
                  <div className="text-xs text-white/60 mb-1">Bear (P10)</div>
                  <div className="text-lg font-bold text-red-400">-18.2%</div>
                </div>

                <div className="p-3 bg-white/5 border border-white/10 rounded-lg">
                  <div className="text-xs text-white/60 mb-1">Base (P50)</div>
                  <div className="text-lg font-bold text-white">+8.5%</div>
                </div>
                <div className="p-3 bg-white/5 border border-white/10 rounded-lg">
                  <div className="text-xs text-white/60 mb-1">Bull (P90)</div>
                  <div className="text-lg font-bold text-green-400">+35.7%</div>
                </div>
              </div>
            </div>
            <div className="p-4 bg-white/5 border border-white/10 rounded-xl">
              <div className="text-xs text-white/60 mb-2">Probability of Positive Return</div>
              <div className="text-3xl font-bold text-green-400">67.3%</div>
            </div>
          </div>
        )}
      </motion.div>
