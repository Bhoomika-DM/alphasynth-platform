...
export default function CompositeSentimentScore({ ticker, onScoreComplete }: CompositeSentimentScoreProps) {
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-blue-500/5 via-[#0D7C8C]/5 to-transparent opacity-50" />
      <div className="absolute top-0 right-0 w-64 h-64 bg-blue-500/10 rounded-full blur-3xl" />
      <div className="absolute bottom-0 left-0 w-64 h-64 bg-[#0D7C8C]/10 rounded-full blur-3xl" />
      ...
      <div className="relative z-10">
        ...
        <div className="flex items-start justify-between mb-6">
          ...
          >
            <h3 className="text-2xl font-black text-white mb-1 bg-gradient-to-r from-white to-white/60 bg-clip-text text-transparent">
          ...
          <motion.button
            ...
            disabled={isRunning}
            className={`px-6 py-2.5 bg-gradient-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 rounded-xl text-sm font-bold text-white shadow-lg transition-all duration-300 ${
            ...
            >
              ...
              >
                ...
                <div className="group relative p-4 bg-gradient-to-br from-green-500/20 via-green-500/10 to-transparent backdrop-blur-xl border border-green-500/30 hover:border-green-500/50 rounded-2xl transition-all duration-300 overflow-hidden">
                  ...
                  <div className="relative z-10">
                    <div className="text-[10px] text-green-400 uppercase tracking-widest mb-2 flex items-center gap-2">
                ...
                <div className="flex gap-2">
                  {tabs.map((tab) => (
                    <button
                      ...
                      className={`relative px-6 py-3 text-sm font-bold transition-all duration-300 ${
                        activeTab === tab.id
                          ? 'text-white'
                    ...
                    >
                      ...
                      {activeTab === tab.id && (
                        <motion.div
                          layoutId="activeTab"
                          className="absolute bottom-0 left-0 right-0 h-0.5 bg-gradient-to-r from-blue-500 to-[#0D7C8C]"
              ...
              <AnimatePresence mode="wait">
                ...
                {activeTab === 'all20' && (
                  <motion.div
                    ...
                    className="space-y-4"
                  >
                    <div className="text-xs text-white/50 uppercase tracking-widest mb-4">
