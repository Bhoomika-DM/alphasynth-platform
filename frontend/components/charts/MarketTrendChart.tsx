...
export default function MarketTrendChart({ 
  ...
  return (
    <div className="bg-white border border-[#0D7C8C]/30 rounded-2xl p-6 shadow-[0_4px_12px_rgba(0,0,0,0.05)]">
      <div className="mb-4">
        <h3 className="text-base font-bold text-[#2D3748] mb-3">{title}</h3>
            ...
            <button
              ...
              className={`px-3 py-2 rounded-md text-xs font-semibold transition-all duration-200 ${
                selectedSector === sector.id
                  ? 'bg-[#0D7C8C] text-[#2D3748] border-2 border-[#2E4D8E]'
                  : 'bg-white text-[#718096] border-2 border-[#0D7C8C]/30 hover:border-[#0D7C8C] hover:text-[#2D3748]'
              }`}
            >
