...
import { IconArrowLeft, IconMail, IconLock, IconUser, IconShield } from '@tabler/icons-react'
  ...
  const handleSignUp = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (error) {
        ...
        // Set flag in localStorage to trigger onboarding after signup
        localStorage.setItem('showOnboarding', 'true')
        
        // Redirect to the intended page (trading if from Market button, otherwise dashboard)
    ...
    <div className="min-h-screen bg-[#F8F9FB] flex items-center justify-center p-6">
      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-[#0D7C8C] rounded-[14px] p-8 shadow-[0_4px_12px_rgba(0,0,0,0.05)]">
          ...
          <button
            onClick={async () => {
              // Set flag for onboarding after Google signup
              localStorage.setItem('showOnboarding', 'true')
          ...
          <div className="flex items-center gap-4 mb-6">
            <div className="flex-1 h-[1px] bg-[#E0F4F6]/40"></div>
            <span className="text-[14px] text-[#E0F4F6]">or</span>
            <div className="flex-1 h-[1px] bg-[#E0F4F6]/40"></div>
          </div>
          ...
          <form onSubmit={handleSignUp} className="space-y-5">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <div className="relative">
                  <IconUser className="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 text-[#718096]" stroke={1.5} />
                  <input
                    type="text"
                    value={firstName}
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="Last"
                  required
                  className="w-full h-[48px] px-4 bg-white rounded-[10px] text-[#2D3748] placeholder:text-[#718096] focus:outline-none focus:ring-2 focus:ring-[#2E4D8E] transition-all duration-200"
                />
              </div>
            </div>
            ...
            <div>
              ...
              <p className="text-[12px] text-[#E0F4F6] mt-1">
            ...
            <div>
              ...
              {confirmPassword && password !== confirmPassword && (
                <p className="text-[12px] text-[#8C1A1A] mt-1">
                  Passwords do not match
                </p>
              )}
              {confirmPassword && password === confirmPassword && (
                <p className="text-[12px] text-[#2E4D8E] mt-1">
                  Passwords match ✓
                </p>
              )}
            </div>
            ...
            <div className="flex items-start gap-3">
              <input
                ...
                className="mt-1 w-5 h-5 rounded border-2 border-[#E0F4F6] text-[#2E4D8E] focus:ring-2 focus:ring-[#2E4D8E]"
                required
              />
              <label htmlFor="terms" className="text-[14px] text-[#FFFFFF]">
                I agree to the{' '}
                <a href="#" className="text-[#E0F4F6] hover:underline font-semibold">
                  Terms of Service
                </a>
                {' '}and{' '}
                <a href="#" className="text-[#E0F4F6] hover:underline font-semibold">
            ...
            <button
              ...
              className="w-full h-[48px] bg-white hover:bg-[#F8F9FB] border border-[#E0F4F6] text-[#0D7C8C] rounded-md font-semibold transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed shadow-sm"
            >
