  ...
  if (loading || stockLoading) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-[#F4F7F2]">
        <div className="text-[#1F2933]">Loading real stock data...</div>
      </div>
    )
  }
        ...
        <div className="bg-white rounded-lg border border-[#5A8A4E]/20 p-4 mb-3">
          <div className="flex items-center justify-between mb-3">
            <div className="flex items-center gap-6">
              <div>
                <div className="flex items-center gap-3 mb-1">
                  <div className="text-3xl font-black text-[#1F2933]">
                    {stock.price.toFixed(2)}
                  </div>
                  <div className={`flex items-center gap-1 text-base font-semibold ${isPositive ? 'text-[#6B9E5D]' : 'text-[#C85A54]'}`}>
                    {isPositive ? <IconArrowUp className="w-4 h-4" stroke={2.5} /> : <IconArrowDown className="w-4 h-4" stroke={2.5} />}
                    {isPositive ? '+' : ''}{stock.change.toFixed(2)} ({stock.changePercent.toFixed(2)}%)
                  </div>
                </div>
                <h1 className="text-sm font-bold text-[#1F2933]">
                  {stock.name} ({stock.isin})
                </h1>
              </div>
              
              <div className="border-l border-[#E5E7EB] pl-6">
                <div className="text-xs text-[#6B7280] mb-1">Close</div>
                <div className="text-xl font-bold text-[#1F2933]">{stock.close.toFixed(2)}</div>
                <div className={`text-sm font-semibold ${isPositive ? 'text-[#6B9E5D]' : 'text-[#C85A54]'}`}>
            ...
            <div className="text-right">
              ...
              <div className="flex gap-2">
                <span className="px-3 py-1 bg-[#A7C4A0] text-[#1F2933] rounded text-xs font-bold">
                  EQ
                </span>
                <span className="px-3 py-1 bg-[#A7C4A0] text-[#1F2933] rounded text-xs font-bold">
                  T0
          ...
          <div className="flex gap-2">
            <a 
              ...
              className="px-3 py-1 bg-[#F4F7F2] text-[#1F2933] rounded text-xs font-semibold hover:bg-[#E5E7EB] cursor-pointer relative z-10"
            >
              Equity
            </a>
            <a 
        ...
        <div className="grid grid-cols-3 gap-3">
          ...
          <div className="col-span-2 bg-white rounded-lg border border-[#5A8A4E]/20 p-4">
            ...
            <div className="grid grid-cols-7 gap-3 mb-3 text-xs">
              <div>
                <div className="text-[#6B7280] mb-0.5">Prev. Close</div>
                <div className="font-bold text-[#1F2933]">{stock.prevClose.toFixed(2)}</div>
              </div>
              <div>
                <div className="flex items-center gap-1 text-[#6B7280] mb-0.5">
                  <div className="w-1.5 h-1.5 rounded-full bg-[#6B7280]"></div>
                  Open
                </div>
                <div className="font-bold text-[#1F2933]">{stock.open.toFixed(2)}</div>
              </div>
              <div>
                <div className="flex items-center gap-1 text-[#6B7280] mb-0.5">
                ...
                <div className="font-bold text-[#6B9E5D]">{stock.high.toFixed(2)}</div>
              </div>
              <div>
                <div className="flex items-center gap-1 text-[#6B7280] mb-0.5">
                ...
                <div className="font-bold text-[#C85A54]">{stock.low.toFixed(2)}</div>
              </div>
              <div>
                <div className="text-[#6B7280] mb-0.5">Close *</div>
                <div className="font-bold text-[#1F2933]">{stock.close.toFixed(2)}</div>
              </div>
              <div>
                <div className="text-[#6B7280] mb-0.5">VWAP</div>
                <div className="font-bold text-[#1F2933]">{stock.vwap.toFixed(2)}</div>
              </div>
              <div>
                <div className="text-[#6B7280] mb-0.5">Adjusted Price *</div>
                <div className="font-bold text-[#1F2933]">{stock.adjustedPrice}</div>
              </div>
            </div>
            ...
            <div className="relative">
              <div className="absolute top-2 right-2 z-10 flex gap-1">
                ...
                <button className="px-2 py-1 rounded text-xs font-semibold bg-white/80 text-[#6B7280] hover:bg-white">
          ...
          <div className="bg-white rounded-lg border border-[#5A8A4E]/20 p-4">
            <h3 className="text-base font-black text-[#1F2933] mb-3">Order Book</h3>
            
            <table className="w-full text-xs">
              <thead>
                <tr className="bg-[#A7C4A0] text-[#1F2933]">
                  <th className="text-left py-1.5 px-2 font-bold">Qty</th>
                  <th className="text-center py-1.5 px-2 font-bold">Bid (₹)</th>
                  <th className="text-center py-1.5 px-2 font-bold">Ask (₹)</th>
                  <th className="text-right py-1.5 px-2 font-bold">Qty</th>
                </tr>
              </thead>
              <tbody>
                {[1, 2, 3, 4, 5].map((_, index) => (
                  <tr key={index} className="border-b border-[#E5E7EB]">
                    <td className="py-1.5 px-2 text-[#1F2933] text-center">-</td>
                    <td className="py-1.5 px-2 text-[#1F2933] text-center">-</td>
                    <td className="py-1.5 px-2 text-[#1F2933] text-center">-</td>
                    <td className="py-1.5 px-2 text-[#1F2933] text-center">-</td>
                  </tr>
            ...
            <div className="mt-4 pt-3 border-t border-[#E5E7EB] space-y-2 text-xs">
              <div className="flex justify-between items-center">
                ...
                <span className="text-[#6B9E5D] font-bold">-</span>
              </div>
              <div className="flex justify-between items-center">
              ...
              <div className="text-center pt-2">
                <div className="text-[#6B7280] mb-0.5">Total Quantity</div>
                <div className="text-base font-black text-[#1F2933]">-</div>
              </div>
            </div>
          </div>
        </div>
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                <div className="flex items-center gap-3">
                  <span className="text-lg font-black text-[#1F2933]">{symbol}</span>
                  <span className="text-2xl font-black text-[#1F2933]">{stock.price.toFixed(2)}</span>
                  <span className={`text-sm font-semibold ${isPositive ? 'text-[#6B9E5D]' : 'text-[#C85A54]'}`}>
                ...
                <div className="flex items-center gap-2 mt-1">
                  ...
                  <span className="text-sm font-bold text-[#1F2933]">{stock.close.toFixed(2)}</span>
                  <span className={`text-sm font-semibold ${(stock.close - stock.prevClose) >= 0 ? 'text-[#6B9E5D]' : 'text-[#C85A54]'}`}>
          ...
          <div className="grid grid-cols-2 gap-0 border-b border-[#5A8A4E]/20">
            ...
            <div className="border-r border-[#5A8A4E]/20 p-4">
              <div className="flex items-center gap-2 mb-3">
                <div className="w-2 h-2 bg-[#6B9E5D] rounded-full"></div>
                <span className="text-sm font-bold text-[#1F2933]">Stock Absolute Returns</span>
              </div>
              <div className="grid grid-cols-6 gap-2">
                <div className="text-center">
                  <div className="text-xs text-[#6B7280] mb-1">1W</div>
                  <div className="px-2 py-1 bg-[#6B9E5D] rounded text-xs font-bold text-white">7.83%</div>
                </div>
                <div className="text-center">
                  <div className="text-xs text-[#6B7280] mb-1">1M</div>
                  <div className="px-2 py-1 bg-[#6B9E5D] rounded text-xs font-bold text-white">3.55%</div>
                </div>
                <div className="text-center">
                  <div className="text-xs text-[#6B7280] mb-1">YTD</div>
                  <div className="px-2 py-1 bg-[#C85A54] rounded text-xs font-bold text-white">-0.55%</div>
                </div>
                <div className="text-center">
                  <div className="text-xs text-[#6B7280] mb-1">1Y</div>
                  <div className="px-2 py-1 bg-[#C85A54] rounded text-xs font-bold text-white">-21.16%</div>
                </div>
                <div className="text-center">
                  <div className="text-xs text-[#6B7280] mb-1">3Y</div>
                  <div className="px-2 py-1 bg-[#C85A54] rounded text-xs font-bold text-white">-21.03%</div>
                </div>
                <div className="text-center">
                  <div className="text-xs text-[#6B7280] mb-1">5Y</div>
                  <div className="px-2 py-1 bg-[#C85A54] rounded text-xs font-bold text-white">-22.25%</div>
                </div>
              </div>
            </div>
            ...
            <div className="p-4">
              <div className="flex items-center gap-2 mb-3">
                <div className="w-2 h-2 bg-[#E5C76A] rounded-full"></div>
                <span className="text-sm font-bold text-[#1F2933]">NIFTY 50 Absolute Returns</span>
              </div>
              <div className="grid grid-cols-6 gap-2">
                <div className="text-center">
                  <div className="text-xs text-[#6B7280] mb-1">1W</div>
                  <div className="px-2 py-1 bg-[#F4F7F2] rounded text-xs font-bold text-[#1F2933]">-</div>
                </div>
                <div className="text-center">
                  <div className="text-xs text-[#6B7280] mb-1">1M</div>
                  <div className="px-2 py-1 bg-[#C85A54] rounded text-xs font-bold text-white">-5.43%</div>
                </div>
                <div className="text-center">
                  <div className="text-xs text-[#6B7280] mb-1">YTD</div>
                  <div className="px-2 py-1 bg-[#C85A54] rounded text-xs font-bold text-white">-11.56%</div>
                </div>
                <div className="text-center">
                  <div className="text-xs text-[#6B7280] mb-1">1Y</div>
                  <div className="px-2 py-1 bg-[#C85A54] rounded text-xs font-bold text-white">-22.31%</div>
                </div>
                <div className="text-center">
                  <div className="text-xs text-[#6B7280] mb-1">3Y</div>
                  <div className="px-2 py-1 bg-[#6B9E5D] rounded text-xs font-bold text-white">31.39%</div>
                </div>
                <div className="text-center">
                  <div className="text-xs text-[#6B7280] mb-1">5Y</div>
                  <div className="px-2 py-1 bg-[#6B9E5D] rounded text-xs font-bold text-white">96.04%</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-3 gap-0">
            ...
            <div className="border-r border-[#5A8A4E]/20 p-4">
              <div className="space-y-2 text-xs">
                <div className="flex justify-between items-center">
                  <span className="text-[#6B7280]">Traded Volume (Lakhs)</span>
                  <span className="text-[#1F2933] font-semibold">46.17</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-[#6B7280]">Total Market Cap (₹ Cr.)</span>
                  <span className="text-[#1F2933] font-semibold">9,20,200.18</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-[#6B7280]">Impact cost</span>
                  <span className="text-[#1F2933] font-semibold">0.02</span>
                </div>
                <div className="flex justify-between items-center">
                  ...
                  <span className="text-[#1F2933] font-semibold">12.50</span>
                </div>
                <div className="pt-2 border-t border-[#E5E7EB]">
                  <div className="flex justify-between items-center">
                    <span className="text-[#6B7280]">Traded Value (₹ Cr.)</span>
                    <span className="text-[#1F2933] font-semibold">1,139.39</span>
                  </div>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-[#6B7280]">Free Float Market Cap (₹ Cr.)</span>
                  <span className="text-[#1F2933] font-semibold">2,59,003.18</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-[#6B7280]">Face Value</span>
                  <span className="text-[#1F2933] font-semibold">1.00</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-[#6B7280] flex items-center gap-1">
                  ...
                  <span className="text-[#1F2933] font-semibold">50.93%</span>
                </div>
              </div>
            </div>
            ...
            <div className="border-r border-[#5A8A4E]/20 p-4">
              <div className="space-y-2 text-xs">
                <div className="flex justify-between items-center">
                  <span className="text-[#6B7280]">Week High (52-Mar-2026)</span>
                  <span className="text-[#1F2933] font-semibold">3,630.50</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-[#6B7280]">Upper Band</span>
                  <span className="text-[#1F2933] font-semibold">2,793.70</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-[#6B7280]">Price Band (%)</span>
                  <span className="text-[#1F2933] font-semibold">No Band</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-[#6B7280]">Daily Volatility</span>
                  <span className="text-[#1F2933] font-semibold">1.41</span>
                </div>
                <div className="pt-2 border-t border-[#E5E7EB]">
                  <div className="flex justify-between items-center">
                    <span className="text-[#6B7280]">52 Week Low (30-Nov-2026)</span>
                    <span className="text-[#1F2933] font-semibold">2,346.20</span>
                  </div>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-[#6B7280]">Lower Band</span>
                  <span className="text-[#1F2933] font-semibold">2,285.90</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-[#6B7280]">Tick Size</span>
                  <span className="text-[#1F2933] font-semibold">0.10</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-[#6B7280]">Annualised Volatility</span>
                  <span className="text-[#1F2933] font-semibold">26.94</span>
                </div>
              </div>
            </div>
            ...
            <div className="p-4">
              <div className="space-y-2 text-xs">
                <div className="flex justify-between items-center">
                  ...
                  <span className="text-[#1F2933] font-semibold">Listed</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-[#6B7280]">Symbol P/F</span>
                  <span className="text-[#1F2933] font-semibold">18.86</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-[#6B7280]">Date of Listing</span>
                  <span className="text-[#1F2933] font-semibold">25-Aug-2004</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-[#6B7280] flex items-center gap-1">
                    Basic Industry
                  ...
                  <span className="text-[#1F2933] font-semibold text-right">Computers - Software & Consulting</span>
                </div>
                <div className="pt-2 border-t border-[#E5E7EB]">
                  <div className="flex justify-between items-center">
                    <span className="text-[#6B7280]">Trading Status</span>
                    <span className="text-[#1F2933] font-semibold">Active</span>
                  </div>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-[#6B7280]">Adjusted P/F</span>
                  <span className="text-[#1F2933] font-semibold">17.42</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-[#6B7280] flex items-center gap-1">
                    Index
                  ...
                  <span className="text-[#1F2933] font-semibold">NIFTY 50</span>
                </div>
              </div>
            </div>
          ...
          <div className="p-4">
            ...
            <div className="flex gap-0 border-b border-[#E5E7EB] mb-4 relative">
              <button 
                ...
                className={`px-4 py-2 text-xs font-bold ${corporateSubTab === 0 ? 'text-[#5A8A4E]' : 'text-[#6B7280] hover:text-[#1F2933]'} relative`}
              >
                Dashboard
              ...
              <button 
                ...
                className={`px-4 py-2 text-xs font-bold ${corporateSubTab === 1 ? 'text-[#5A8A4E]' : 'text-[#6B7280] hover:text-[#1F2933]'} relative`}
              >
                Announcements
              ...
              <button 
                ...
                className={`px-4 py-2 text-xs font-bold ${corporateSubTab === 2 ? 'text-[#5A8A4E]' : 'text-[#6B7280] hover:text-[#1F2933]'} relative`}
              >
                Announcements XBRL
              ...
              <button 
                ...
                className={`px-4 py-2 text-xs font-bold ${corporateSubTab === 3 ? 'text-[#5A8A4E]' : 'text-[#6B7280] hover:text-[#1F2933]'} relative`}
              >
                Board Meetings
              ...
              <button 
                ...
                className={`px-4 py-2 text-xs font-bold ${corporateSubTab === 4 ? 'text-[#5A8A4E]' : 'text-[#6B7280] hover:text-[#1F2933]'} relative`}
              >
                Corporate Actions
              ...
              <button 
                ...
                className="px-4 py-2 text-xs font-bold text-[#6B7280] hover:text-[#1F2933] flex items-center gap-1 relative"
              >
                More
              ...
              {showMoreDropdown && (
                <div className="absolute top-full right-0 mt-1 bg-white border border-[#E5E7EB] rounded shadow-lg z-50 min-w-[250px]">
                  <button 
                    ...
                    className="w-full text-left px-4 py-2 text-xs text-[#1F2933] hover:bg-[#F4F7F2]"
                  >
                    Annual Reports
                  </button>
                  <button 
            ...
            <div className="mt-4">
                {corporateSubTab === 0 && (
                  <div className="space-y-6">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      ...
                      <div>
                        <div className="flex items-center justify-between mb-3">
                          <h4 className="text-sm font-black text-[#1F2933]">Corporate Announcements</h4>
                          <button className="text-xs font-semibold text-[#E5C76A] hover:text-[#D4B65A] flex items-center gap-1">
                            View More
                            <span className="text-[10px]">▶</span>
                          </button>
                        </div>
                          ...
                          {[
                            ...
                            <div key={index} className="flex items-start justify-between gap-3 pb-3 border-b border-[#E5E7EB] last:border-0">
                              <div className="flex-1">
                                <div className="text-xs font-bold text-[#1F2933] mb-1">{item.title}</div>
                              ...
                              <div className="text-[10px] text-[#6B7280] text-right">{item.size}</div>
                            </div>
                          ))}
                        </div>
                      </div>
                      ...
                      <div>
                        <div className="flex items-center justify-between mb-3">
                          <h4 className="text-sm font-black text-[#1F2933]">Corporate Actions</h4>
                          <button className="text-xs font-semibold text-[#E5C76A] hover:text-[#D4B65A] flex items-center gap-1">
                            View More
                            <span className="text-[10px]">▶</span>
                          </button>
                        ...
                        <div className="space-y-3">
                          {[
                            ...
                            <div key={index} className="pb-3 border-b border-[#E5E7EB] last:border-0 border-l-4 border-[#E5C76A] pl-3">
                              <div className="text-xs font-bold text-[#1F2933] mb-2">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      ...
                      <div>
                        <div className="flex items-center justify-between mb-3">
                          <h4 className="text-sm font-black text-[#1F2933]">Annual Reports</h4>
                          <button className="text-xs font-semibold text-[#E5C76A] hover:text-[#D4B65A] flex items-center gap-1">
                            View More
                            <span className="text-[10px]">▶</span>
                          </button>
                      ...
                      <div>
                        <div className="flex items-center justify-between mb-3">
                          <h4 className="text-sm font-black text-[#1F2933]">Business Responsibility & Sustainability Report</h4>
                          <button className="text-xs font-semibold text-[#E5C76A] hover:text-[#D4B65A] flex items-center gap-1">
                            View More
                            <span className="text-[10px]">▶</span>
                          </button>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      ...
                      <div>
                        <div className="flex items-center justify-between mb-3">
                          <h4 className="text-sm font-black text-[#1F2933]">Event Calendar</h4>
                          <button className="text-xs font-semibold text-[#E5C76A] hover:text-[#D4B65A] flex items-center gap-1">
                            View More
                            <span className="text-[10px]">▶</span>
                          </button>
                      ...
                      <div>
                        <div className="mb-3">
                          <h4 className="text-sm font-black text-[#1F2933]">Security Status</h4>
                        </div>
                        ...
                        <div className="border border-[#E5E7EB] rounded p-4">
                          <div className="space-y-3 text-xs">
                            <div className="flex justify-between items-center pb-2 border-b border-[#E5E7EB]">
                              <span className="text-[#6B7280]">Board Status</span>
                              <span className="text-[#1F2933] font-semibold">Main</span>
                            </div>
                            <div className="flex justify-between items-center pb-2 border-b border-[#E5E7EB]">
                              <span className="text-[#6B7280]">Trading Segment</span>
                              <span className="text-[#1F2933] font-semibold">Normal Market</span>
                            </div>
                            <div className="flex justify-between items-center pb-2 border-b border-[#E5E7EB]">
                              <span className="text-[#6B7280]">Session No.</span>
                              <span className="text-[#1F2933] font-semibold">-</span>
                            </div>
                            <div className="flex justify-between items-center pb-2 border-b border-[#E5E7EB]">
                              <span className="text-[#6B7280]">Class of Shares</span>
                              <span className="text-[#1F2933] font-semibold">Equity</span>
                            </div>
                            <div className="flex justify-between items-center pb-2 border-b border-[#E5E7EB]">
                              <span className="text-[#6B7280]">SDD Compliance</span>
                              <span className="text-[#1F2933] font-semibold">-</span>
                            </div>
                            <div className="flex justify-between items-center">
                              <span className="text-[#6B7280]">Name of Compliance Officer</span>
                              <span className="text-[#1F2933] font-semibold">-</span>
                            </div>
                          </div>
                        </div>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      ...
                      <div>
                        <div className="flex items-center justify-between mb-3">
                          <h4 className="text-sm font-black text-[#1F2933]">Shareholding Patterns</h4>
                          <button className="text-xs font-semibold text-[#E5C76A] hover:text-[#D4B65A] flex items-center gap-1">
                            View More
                            <span className="text-[10px]">▶</span>
                          </button>
                        ...
                        <div className="flex items-center gap-2 mb-4">
                          {['Q1', 'Q2', 'Q3', 'Q4'].map((quarter) => (
                            <button
                              key={quarter}
                              className="px-3 py-1.5 text-xs font-semibold bg-[#F4F7F2] text-[#1F2933] rounded hover:bg-[#A7C4A0] transition-colors"
                            >
                              {quarter}
                            </button>
                          ))}
                          ...
                          <div className="space-y-2 mt-2">
                            <div className="flex items-center justify-between text-xs">
                              <div className="flex items-center gap-2">
                                ...
                                <span className="text-[#1F2933]">Promoter & Promoter Group</span>
                              </div>
                              <span className="font-bold text-[#1F2933]">72.05%</span>
                            </div>
                            <div className="flex items-center justify-between text-xs">
                              <div className="flex items-center gap-2">
                                <div className="w-3 h-3 rounded-full bg-[#E5C76A]"></div>
                                <span className="text-[#1F2933]">Public</span>
                              </div>
                              <span className="font-bold text-[#1F2933]">27.95%</span>
                            </div>
                          </div>
                      ...
                      <div>
                        <div className="flex items-center justify-between mb-3">
                          <h4 className="text-sm font-black text-[#1F2933]">Financial Results</h4>
                          <button className="text-xs font-semibold text-[#E5C76A] hover:text-[#D4B65A] flex items-center gap-1">
                            View More
                            <span className="text-[10px]">▶</span>
                          </button>
                    ...
                    <div>
                      <div className="flex items-center justify-between mb-3">
                        <h4 className="text-sm font-black text-[#1F2933]">Board Meetings</h4>
                        <button className="text-xs font-semibold text-[#E5C76A] hover:text-[#D4B65A] flex items-center gap-1">
                          View More
                          <span className="text-[10px]">▶</span>
                        </button>
                          ...
                          <div key={index} className="border border-[#E5E7EB] rounded p-4 hover:bg-[#F4F7F2] transition-colors">
                            <div className="flex items-start justify-between gap-3 mb-3">
                              ...
                              <div className="flex flex-col items-end gap-1">
                                ...
                                <div className="text-[10px] text-[#6B7280]">{meeting.size}</div>
                              </div>
                            </div>
                ...
                {corporateSubTab === 1 && (
                  <div>
                    ...
                    <h3 className="text-lg font-black text-[#1F2933] mb-4">Corporate Announcements</h3>
                    ...
                    <div className="flex items-center justify-between mb-4">
                      <div className="flex items-center gap-4 flex-1">
                        ...
                        <div className="flex-1 max-w-md">
                          <input
                            ...
                            className="w-full px-4 py-2 text-xs border border-[#E5E7EB] rounded focus:outline-none focus:border-[#A7C4A0]"
                          />
                        </div>
                        ...
                        <div className="flex items-center gap-2">
                          {['1D', '1W', '1M', '3M', '6M', '1Y'].map((period) => (
                            <button
                              key={period}
                              className="px-3 py-1.5 text-xs font-semibold bg-[#A7C4A0] text-[#1F2933] rounded hover:bg-[#6A994E] hover:text-white transition-colors"
                            >
                              {period}
                            </button>
                          ))}
                      ...
                      <div className="flex items-center gap-2">
                        <button className="px-3 py-1.5 bg-[#E5C76A] text-[#1F2933] rounded text-xs font-semibold hover:bg-[#D4B65A]">
                          Convert XBRL into Excel
                        </button>
                        <button className="px-3 py-1.5 bg-white border border-[#E5E7EB] rounded text-xs font-semibold text-[#1F2933] hover:bg-[#F4F7F2]">
                          View More
                        </button>
                      </div>
                    </div>
                      ...
                      {[
                        ...
                        <div key={index} className={`border-l-4 ${item.borderColor} bg-[#F9FAFB] p-4 rounded-r-lg`}>
                          <div className="flex items-start justify-between">
                            <div className="flex-1">
                              <div className="flex items-center justify-between mb-2">
                                <h5 className="text-sm font-bold text-[#1F2933]">{item.title}</h5>
                            ...
                            <div className="flex items-center gap-2 ml-4">
                              ...
                              <div className="text-xs text-[#6B7280]">{item.size}</div>
                            </div>
                          </div>
                        </div>
                      ))}
                ...
                {corporateSubTab === 2 && (
                  <div>
                    <div className="flex items-center justify-between mb-4">
                      <h4 className="text-base font-black text-[#1F2933]">Announcement XBRL</h4>
                      <div className="flex items-center gap-2">
                        <button className="px-3 py-1.5 bg-[#E5C76A] text-[#1F2933] rounded text-xs font-semibold hover:bg-[#D4B65A]">
                          Convert XBRL into Excel
                        </button>
                    ...
                    <div className="mb-4">
                      <label className="text-xs font-semibold text-[#1F2933] mb-2 block">Announcement Type</label>
                      <select className="w-full px-3 py-2 text-xs border border-[#E5E7EB] rounded focus:outline-none focus:border-[#A7C4A0]">
                ...
                {corporateSubTab === 3 && (
                  <div>
                    <div className="flex items-center justify-between mb-4">
                      <h4 className="text-base font-black text-[#1F2933]">Board Meeting Intimation</h4>
                      <button className="px-3 py-1.5 bg-white border border-[#E5E7EB] rounded text-xs font-semibold text-[#1F2933] hover:bg-[#F4F7F2]">
                        View More
                      </button>
                    </div>
                      ...
                      {[
                        ...
                        <div key={index} className="p-4 border border-[#E5E7EB] rounded hover:bg-[#F4F7F2]">
                          <div className="flex items-start justify-between mb-2">
                            <div className="flex-1">
                              <div className="text-sm font-bold text-[#1F2933] mb-1">{item.title}</div>
                              <div className="text-xs text-[#6B7280] mb-2">
                ...
                {corporateSubTab === 4 && (
                  <div>
                    <div className="mb-4">
                      <h4 className="text-base font-black text-[#1F2933]">Corporate Actions</h4>
                    </div>
                      ...
                      <table className="w-full text-xs">
                        <thead>
                          <tr className="bg-[#6A994E] text-white">
                            <th className="text-left py-3 px-4 font-bold uppercase">SERIES</th>
                            <th className="text-left py-3 px-4 font-bold uppercase">FACE VALUE</th>
                            <th className="text-left py-3 px-4 font-bold uppercase">PURPOSE</th>
                            <th className="text-center py-3 px-4 font-bold uppercase">EX-DATE</th>
                            <th className="text-center py-3 px-4 font-bold uppercase">RECORD DATE</th>
                            <th className="text-center py-3 px-4 font-bold uppercase">BOOK CLOSURE START DATE</th>
                            <th className="text-center py-3 px-4 font-bold uppercase">BOOK CLOSURE END DATE</th>
                          </tr>
                        </thead>
                        <tbody>
                          {[
                            ...
                            <tr key={index} className={`${index % 2 === 0 ? 'bg-white' : 'bg-[#F9FAFB]'} hover:bg-[#F4F7F2]`}>
                              <td className="py-3 px-4 text-[#1F2933]">{item.series}</td>
                              <td className="py-3 px-4 text-[#1F2933]">{item.faceValue}</td>
                              <td className="py-3 px-4 text-[#1F2933]">{item.purpose}</td>
                              <td className="py-3 px-4 text-[#1F2933] text-center">{item.exDate}</td>
                              <td className="py-3 px-4 text-[#1F2933] text-center">{item.recordDate}</td>
                              <td className="py-3 px-4 text-[#1F2933] text-center">{item.bcStart}</td>
                              <td className="py-3 px-4 text-[#1F2933] text-center">{item.bcEnd}</td>
                            </tr>
                          ))}
                        </tbody>
                      </table>
                    ...
                    <div className="flex items-center justify-between mt-4">
                      ...
                      <div className="flex items-center gap-2">
                        <button className="w-8 h-8 flex items-center justify-center border border-[#E5E7EB] rounded text-xs text-[#6B7280] hover:bg-[#F4F7F2]">
                          «
                        </button>
                        <button className="w-8 h-8 flex items-center justify-center border border-[#E5E7EB] rounded text-xs text-[#6B7280] hover:bg-[#F4F7F2]">
                          ‹
                        </button>
                        <button className="w-8 h-8 flex items-center justify-center bg-[#E5C76A] text-[#1F2933] rounded text-xs font-bold">
                          1
                        </button>
                        <button className="w-8 h-8 flex items-center justify-center border border-[#E5E7EB] rounded text-xs text-[#6B7280] hover:bg-[#F4F7F2]">
                          2
                ...
                {corporateSubTab === 5 && (
                  <div>
                    <div className="flex items-center justify-between mb-4">
                      <h4 className="text-base font-black text-[#1F2933]">Annual Reports</h4>
                      <button className="px-3 py-1.5 bg-white border border-[#E5E7EB] rounded text-xs font-semibold text-[#1F2933] hover:bg-[#F4F7F2]">
                        View More
                      </button>
                    </div>
                ...
                {corporateSubTab === 6 && (
                  <div>
                    <div className="flex items-center justify-between mb-4">
                      <h4 className="text-base font-black text-[#1F2933]">Business Responsibility and Sustainability Report</h4>
                      <button className="px-3 py-1.5 bg-white border border-[#E5E7EB] rounded text-xs font-semibold text-[#1F2933] hover:bg-[#F4F7F2]">
                        View More
                      </button>
                    </div>
                    ...
                    <div className="space-y-3">
                      {[
                        ...
                        <div key={index} className="grid grid-cols-4 gap-4 p-3 border border-[#E5E7EB] rounded hover:bg-[#F4F7F2]">
                          <div>
                            <div className="text-xs text-[#6B7280] mb-1">From Year: {item.fromYear}</div>
                            <div className="text-xs text-[#6B7280]">To Year: {item.toYear}</div>
                          </div>
                          <div>
                            <div className="text-xs text-[#6B7280] mb-1">Original Submission Date:</div>
                            <div className="text-xs font-bold text-[#1F2933]">{item.originalDate}</div>
                          </div>
                          <div>
                            <div className="text-xs text-[#6B7280] mb-1">Latest Revision Date:</div>
                            <div className="text-xs font-bold text-[#1F2933]">{item.latestDate}</div>
                          </div>
                          <div className="flex items-center justify-end gap-2">
                            <button className="w-8 h-8 flex items-center justify-center bg-[#E5C76A] text-white rounded hover:bg-[#D4B65A]">
                              <IconFileTypePdf className="w-4 h-4" stroke={1.5} />
                            </button>
                            <div className="text-xs text-[#6B7280]">{item.pdfSize}</div>
                            <button className="w-8 h-8 flex items-center justify-center bg-[#C85A54] text-white rounded hover:bg-[#B84A44]">
                              <IconFileTypePdf className="w-4 h-4" stroke={1.5} />
                            </button>
                            <div className="text-xs text-[#6B7280]">{item.xmlSize}</div>
                          </div>
                        </div>
                      ))}
                    </div>
