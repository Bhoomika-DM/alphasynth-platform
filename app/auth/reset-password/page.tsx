          ...
          <div className="w-full max-w-md">
            <div className="glass-card rounded-3xl p-11 text-center space-y-8">
              ...
              <div className="space-y-2">
                <h1 className="text-3xl font-jakarta font-bold text-white">Password updated</h1>
        ...
        <div className="w-full max-w-md">
          <div className="glass-card rounded-3xl p-11 space-y-8">
            <div className="text-center space-y-2">
              <h1 className="text-3xl font-jakarta font-bold text-white">Set new password</h1>
              <p className="text-text-secondary font-jakarta">
