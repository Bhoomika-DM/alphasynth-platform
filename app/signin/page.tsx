  ...
  const handleSignIn = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (error) {
        ...
        // Check if coming from Analyze button (redirect=onboarding)
          ...
          <form onSubmit={handleSignIn} className="space-y-5">
            ...
            <div>
              <div className="flex items-center justify-between mb-2">
                <label className="text-[14px] font-semibold text-[#1F2933] font-jakarta">
                  Password
                </label>
                <Link
                  href="/forgot-password"
                  className="text-[14px] text-[#6A994E] hover:underline font-jakarta"
                >
                  Forgot?
                </Link>
              </div>
            ...
            <div className="flex items-center gap-3">
              <input
                ...
                className="w-5 h-5 rounded border-2 border-[#6B7280] text-[#6A994E] focus:ring-2 focus:ring-[#6A994E]"
              />
              <label htmlFor="remember" className="text-[14px] text-[#1F2933] font-jakarta">
